...
final class Version20221005073233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE server_ram_module ADD CONSTRAINT FK_AB74932CDFC5FC5E FOREIGN KEY (server_id) REFERENCES server (id)');
        $this->addSql('ALTER TABLE server_ram_module ADD CONSTRAINT FK_AB74932C8AC2A195 FOREIGN KEY (ram_id) REFERENCES ram_module (id)');
    }
